  ...
  return (
    <>
      <div className="bg-[conic-gradient(at_bottom_right,_var(--tw-gradient-stops))] from-blue-700 via-blue-800 to-gray-900 min-h-full lg:h-[88vh] ">
        <div className="flex flex-col lg:flex-row py-[5vh] justify-center items-center container mx-auto ">
        <MainPicture/>
          <div className="w-10/12 lg:w-1/2 flex justify-center items-center lg:items-start  flex-col gap-y-4 ">
            <div>
