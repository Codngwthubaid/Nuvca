  ...
  return (
    <>
      <div className="bg-[conic-gradient(at_bottom_right,_var(--tw-gradient-stops))] from-blue-700 via-blue-800 to-gray-900 min-h-full lg:h-[88vh] ">
        <div className="flex flex-col lg:flex-row gap-y-3  justify-center items-center container mx-auto ">
          <MainPicture />
          <div className="w-10/12 lg:w-1/2 flex justify-center mb-16 items-center lg:items-start pt-5 flex-col gap-y-4 ">
            <div>
            ...
            <div>
              <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                <Link href="/Login">let's Started</Link>
              </button>
            </div>
          </div>
        </div>
