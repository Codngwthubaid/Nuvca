...
const Navbar = () => {
    return (
        <>
            <header>
                <nav className="bg-white border-gray-200 dark:bg-gray-900 h-auto sm:h-[12vh]">
                    <div className="flex flex-wrap justify-between items-center  min-w-full max-w-screen-xl p-4">
                        ...
                        <div className="flex items-center space-x-6 rtl:space-x-reverse">
                            ...
                            <Link href="/SignIn" className="text-md  text-blue-400 dark:text-blue-500 hover:underline">Sign In</Link>
